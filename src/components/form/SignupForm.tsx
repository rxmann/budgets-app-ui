        ...
        <form onSubmit={handleSubmit(onSubmit)} className={cn("flex flex-col gap-4", className)} {...props}>
            <FieldGroup className="gap-5">
                <div className="flex flex-col items-center gap-1.5 text-center">
                    <div className="flex size-10 items-center justify-center rounded-xl bg-primary text-primary-foreground shadow-sm mb-1">
                        <GalleryVerticalEnd className="size-5" />
                    </div>
                    <h1 className="text-2xl font-bold tracking-tight">Create an account</h1>
                    <p className="text-xs text-balance text-muted-foreground">
                        Get started with your free BudJet account today
                    </p>
                </div>
                {error && (
                ...
                <Field className="flex-col gap-1.5">
                    <FieldLabel htmlFor="name" className="text-xs">Username</FieldLabel>
                    <Input id="name" type="text" placeholder="John Doe" className="h-9 text-sm" {...register("username")} />
                ...
                <Field className="flex-col gap-1.5">
                    ...
                    <Input id="email" type="email" placeholder="m@example.com" className="h-9 text-sm" {...register("email")} />
                ...
                <Field className="flex-col gap-1.5">
                    ...
                    <div className="relative">
                        <Input id="password" type={showPassword ? "text" : "password"} className="h-9 text-sm pr-9 w-full" {...register("password")} />
                        <button
                            type="button"
                ...
                <div className="w-full">
                    <Button variant="outline" type="button" className="flex items-center justify-center gap-2 h-9 text-sm w-full">
